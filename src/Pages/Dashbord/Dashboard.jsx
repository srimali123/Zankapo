        ...
        <Col xs={24} sm={24} md={24} lg={24} xl={24}>
          <Tabs>
            <div className="tabSection">
              <TabList>
                <Tab className="tabPane2 titletab">Sales dashboard</Tab>
                <Tab className="tabPane titletab">My Listings</Tab>
                <Tab className="tabPane titletab">My profile</Tab>
                <Tab className="tabPane titletab">Notifications</Tab>
              </TabList>
            </div>
            ...
            <div>
              ...
              <TabPanel className="tabPanelSection">
                <Row gutter={[0, 20]}>
                  <Col xs={24} sm={24} md={7} lg={4} xl={4} className="listNavLinks">
               ...
               <p className="countList">0 items</p>
                  ...
                  <Col xs={24} sm={24} md={15} lg={19} xl={19} className="cardListingContainer">
                  <div className="cardSectionSearch">
                    <Row  className="cardRow" gutter={20}>
                      ...
                      <Col xs={18} sm={18} md={18} lg={18} xl={18} className="detailsSectionCard">
                       <Link><img src={Images.common.dotButtton} alt="dotmenu"  className="dotmenu"/></Link> 
              ...
              <TabPanel className="tabPanelSection tabPanelsectionProfile">
                <Row gutter={[0, 20]}>
                  <Col xs={24} sm={24} md={6} lg={5} xl={4} className="listNavLinks profilelink">
                    <div className="listingBox">
                  ...
                  {/* <Col xs={24} sm={24} md={17} lg={15} xl={15} className="cardListingContainer profileCont">
                <p className="profileLabel">Name</p>
                <Input placeholder="Enter your name" className="profileInput" />

                <p className="profileLabel secondLabel">Phone number</p>
                <Input placeholder="Enter your mobile number" className="profileInput" />

                <p className="profileLabel secondLabel">NRC Number</p>
                <Input placeholder="Enter your NRC Number" className="profileInput" />

                <p className="profileLabel secondLabel">Email</p>
                <Input placeholder="Enter your Email" className="profileInput" />
                ...
                <Input placeholder="old password" className="profileInput" />

                <p className="profileLabel secondLabel">New password</p>
                <Input placeholder="New passowrd" className="profileInput" />

                  <p className="profileLabel secondLabel">Repeat new password</p>
                <Input placeholder="Repeat password" className="profileInput" />
